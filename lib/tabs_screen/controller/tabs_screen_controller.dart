...
class TabsScreenController extends ChangeNotifier {
  TabsScreenController(this.context);
  ...
  bool isProductFavorite(int index) => selectedProduct.contains(index);

  getProductItem() {
    return ShipingModel.fromJson({
      "product_items": [
        {
          "id": 1,
